...
## -*- texinfo -*- 
## @deftypefn {} {@var{retval} =} mzyx (@var{input1}, @var{input2})
##
## @seealso{}
## @end deftypefn
...
function out_matrix = zyx( alfa, beta, gama )
%Rotaciona o in_point gama em torno de x, beta em torno de y e alfa em
%torno de x. ANGULOS EM RADIANOS!
addpath('../Basic_Transformations/');
out_matrix = mrotz(alfa)*mroty(beta)*mrotx(gama)
